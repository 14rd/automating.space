...
function page(p) {
  const tr = buildTr(p);
  const buyHref = 'mailto:hello@automating.hu?subject=' + encodeURIComponent('Megrendelés: ' + p.hu.title);
...
.mob-br { display:none; }
#matrix { position:fixed; inset:0; pointer-events:none; z-index:0; }
...
console.log('Rebuilt store-deploy/ (index.html, favicon.svg, termek/)');
